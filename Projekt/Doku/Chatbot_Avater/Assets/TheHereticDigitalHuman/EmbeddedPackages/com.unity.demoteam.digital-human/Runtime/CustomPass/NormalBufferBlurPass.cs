	...
	public class NormalBufferBlurPass : CustomPass
	{
		...
		void UpdateDBufferNormalMaskRTIDs(HDRenderPipeline hdPipeline)
		{
	...
	#endif
			{
				...
				{
					var mrt = cachedField_m_DBufferOutput_mrt.GetValue(cachedValue_m_DBufferOutput) as UnityEngine.Rendering.RenderGraphModule.TextureHandle[];
					if (mrt != null)
					{
	...
	#endif
			{
				...
				if (field_m_DBufferOutput != null)
				{
					...
					if (value_m_DBufferOutput != null)
					{
						...
						if (field_mrt != null)
						{
							var value_mrt = field_mrt.GetValue(value_m_DBufferOutput) as UnityEngine.Rendering.RenderGraphModule.TextureHandle[];
							if (value_mrt != null)
							{
